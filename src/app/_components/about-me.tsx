...
import { Coffee, Zap, Users, FolderGit2 } from "lucide-react";
...
const AboutMeSection = () => {
  const stats = [
    { value: "3+",   label: "Years of Experience",  color: "text-orange-500", bg: "bg-orange-50",  icon: Zap         },
    { value: "30+",  label: "Happy Clients",         color: "text-violet-600", bg: "bg-violet-50",  icon: Users       },
    { value: "50+",  label: "Projects Completed",    color: "text-orange-500", bg: "bg-orange-50",  icon: FolderGit2  },
    { value: "100+", label: "Cups of Coffee",        color: "text-violet-600", bg: "bg-violet-50",  icon: Coffee      },
  ];
    ...
    >
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center mb-10">
          ...
          {/* Left: Illustration with Floating Tech Badges */}
